...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    try {
      ...
      console.log(`\x1b[32m[${getTimestamp()}][BAN COMMAND]:\x1b[0m ${interaction.user.tag} banned ${targetUser.user.tag} from ${interaction.guild.name}`)
    } catch (error) {
      console.log(`\x1b[31m[${getTimestamp()}][BAN COMMAND ERROR]:\x1b[0m There was an error when banning: ${error}`);
    }
  },
